...
Puzzle games focus on logical and intellectual obstacles, although they frequently include time-pressure or other action components. Although many action or adventure games include puzzles, such as collecting difficult-to-reach things, a true puzzle game emphasises problem solving as the core gameplay mechanic. Games typically contain shapes, colours, or symbols that the player must manipulate directly or indirectly into a specified pattern. {% include refpointer.html id=12 %}

Puzzle games often show a sequence of similar puzzles that are variations on a same idea. This might entail pattern recognition, logic, or understanding a process. These games often feature a straightforward set of rules in which players manipulate game pieces on a grid, network, or other interaction area. {% include refpointer.html id=12 %}

#### Idle games

In an idle game, players perform basic activities, such as clicking a button, which earns them in-game currency. The currency may be spent to buy equipment or skills that allow the player to acquire the currency more quickly or automatically without having to do the first activity. {% include refpointer.html id=13 %}

A recurring topic is providing the player with sources of money represented by structures such as factories or farms. These sources improve the pace of currency gain, however higher tier sources generally have an exponentially greater cost, therefore upgrading between tiers usually takes the same amount of time or even longer. {% include refpointer.html id=13 %}

This provides an environment with no way to “lose”, low-pressure (as you do not have to play constantly to succeed), and steady progress and feedback, which is ideal for social or mobile play patterns and typically provides high levels of player retention. {% include refpointer.html id=13 %}
...
|                                                           | Corsair Vengeance RGB {% include refpointer.html id=47 %}    | HyperX Predator DDR4 RGB {% include refpointer.html id=47 %}       | Corsair Dominator Platinum RGB {% include refpointer.html id=47 %} | G.Skill Trident Z5 RGB Series {% include refpointer.html id=47 %} |
|-----------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|                                                                   |
