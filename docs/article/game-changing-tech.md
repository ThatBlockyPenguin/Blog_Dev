...
As of writing, the highest ranking CPUs as according to Tom's Hardware are (in no particular order): {% include refpointer.html id=39 %}
...
| Outputs            | 1x HDMI 2.1                                                    | 1x HDMI 2.1                                                | 1x HDMI 2.1                                                 | 1x HDMI                                                        | 3x DisplayPort 1.4a                                         | 1x HDMI 2.1                                                 |
| 2x DisplayPort 2.1 | 2x DisplayPort 2.1                                             | 3x DisplayPort 1.4a                                        | 3x DisplayPort                                              | 1x HDMI 2.1a                                                   | 3x DisplayPort 1.4a                                         |
